...
describe UsersController do
  ...
  describe "GET 'index'" do
    ...
    describe "for signed-in users" do
      ...
      before(:each) do
        ...
        Factory(:user, :email => "123@example.com")
        Factory(:user, :email => "456@example.com")
        Factory(:user, :email => "789@example.net")
      ...
      # Chapt 10.4.2 -- This is the correct section, but this test does
      # not appear in the book, only in the screencast
  ...
  describe "Post 'create'" do
    ...
    describe "success" do
      before(:each) do
        @attr = { :name => "New User", :email => "user333@example.com",
      ...
      it "should redirect to the user show paga" do
        post :create, :user => @attr
  ...
  describe "PUT 'update'" do
    ...
    describe "success" do
      ...
      it "should change the users's attributes" do
        put :update, :id => @user, :user => @attr
        user = assigns(:user)
        @user.reload
  ...
  describe "authentication of edit/update actions" do
    ...
    describe "for signed-in users" do
      ...
      before(:each) do
        wrong_user = Factory(:user, :email => "user123@example.com")
  ...
  describe "follow pages" do
    ...
    describe "when signed in" do
      ...
      before(:each) do
        @user = test_sign_in(Factory(:user))
        @other_user = Factory(:user, :name => "Michael Hartl", :email => Factory.next(:email))
